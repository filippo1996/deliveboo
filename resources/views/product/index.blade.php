                ...
                <tr>
                  ...
                  <td class="text-center">
                    <div class="btn btn-outline-success">
                      <a 
                        href="{{ route('products.show', ['product'=>$product->slug]) }}" class="text-muted">
                          <svg 
                  ...
                  <td class="text-center">
                    <div class="btn btn-outline-info">
                      <a 
                        href="{{ route('products.edit', ['product'=>$product->id]) }}" class="text-muted">
                          <svg 
                            xmlns="http://www.w3.org/2000/svg" 
                            width="16" 
                            height="16" 
                  ...
                  <td class="text-center">
                    <div class="btn btn-outline-danger">
                      <a 
                        href="{{ route('products.destroy', ['product'=>$product->id]) }}" class="text-muted">
                          <svg 
                            xmlns="http://www.w3.org/2000/svg" 
                            width="16" 
                            height="16" 
